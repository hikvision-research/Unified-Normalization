...
class TransformerConfig(FairseqDataclass):
    ...
    norm_type: str = field(
        default="LN",
        metadata={"help": "The type of normalization, choose from ['LN', 'UN1d']"},
    )
    
    un_win: Optional[int] = field(
        default=4,
        metadata={"help": "the window size of UN1d, default: 4"},
    )
    
    un_warmup: Optional[int] = field(
        default=4000,
        metadata={"help": "the warming-up step of UN1d, default: 4000"},
    )
